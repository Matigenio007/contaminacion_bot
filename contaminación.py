...
#tiempode deterioro del plástico
@bot.command()
async def deterioro_del_plástico(ctx):
    tiempo = "Una simple bolsa de plástico, por ejemplo, puede tardar en descomponerse de media en torno a los 150 años y  Una botella de plástico puede tardar 1.000 años en desaparecer."
    await ctx.send(tiempo)
@bot.command()
async def basureros(ctx):
    with open('contendores/contenedores-para-el-reciclaje.jpg', 'rb') as f:
